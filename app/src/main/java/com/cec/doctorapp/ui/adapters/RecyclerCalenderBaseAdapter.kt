...
abstract class RecyclerCalenderBaseAdapter(
        startDate: Date,
        endDate: Date,
    ...
    var mHandlerThread: MyHandlerThread =
            MyHandlerThread(
                    ...
                    RecyclerCalenderBaseAdapter::class.java.simpleName
            )
    ...
    init {
        ...
        if (configuration.calenderViewType == RecyclerCalenderConfiguration.CalenderViewType.HORIZONTAL) {
...
//            }
        ...
        val runnable = Runnable {
            while (startCalendar.time.before(endCalendar.time) || startCalendar.time == endCalendar.time) {
                ...
                if (configuration.calenderViewType == RecyclerCalenderConfiguration.CalenderViewType.VERTICAL && dayOfMonth == 1) { // First Day of month
