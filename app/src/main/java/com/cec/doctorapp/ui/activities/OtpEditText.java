...
import com.cec.doctorapp.ui.interfaces.OnCompleteListener;
...
public class OtpEditText extends AppCompatEditText implements TextWatcher {
    ...
    private void getAttrsFromTypedArray(AttributeSet attributeSet) {
        ...
        mPrimaryColor = a.getColor(R.styleable.OtpEditText_oev_length, getResources().getColor(android.R.color.black));
